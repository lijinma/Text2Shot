...
- **5 套风格模板**：Clean Editorial、Dark Elegant、Bold Magazine、Minimal Ink、WeChat——每套含完整色值表与 CSS overrides
...
| 3 | **Bold Magazine** | 全出血深色头图，扁平色块 | 社媒传播、强视觉冲击 |
| 4 | **Minimal Ink** | 纯白，大留白，无卡片 | 短内容、品质感优先 |
| 5 | **WeChat** | 微信绿，浮动白色卡片 | 微信群分享 |
